Regression trees through the ‘party’ library in R is a great way to build a visual predictive model. The underlying ‘party’ package for R allows for an easy visual representation of the model output.
